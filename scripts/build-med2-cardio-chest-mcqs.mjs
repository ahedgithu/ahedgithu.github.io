...
const sourceDefinitions = [
  ...
  {
    id: 'med2-medical-final-exam-80',
    label: 'Medical Final Examination (80 MCQs)',
    fileRelPaths: [
      path.join('past exams', 'Medical_Final_Examination_80_MCQs.json')
    ],
    prefix: 'med2-final-exam-80',
    expectedCount: 80,
    groupEyebrow: 'MED-2 medical final examination',
    groupNoun: 'topic',
    prompt: 'Choose a topic from Medical Final Examination (80 MCQs).',
    mixedMeta: 'Random questions from Medical Final Examination.',
    wrongReviewId: 'med2-final-exam-80-wrong-review',
    format: 'json',
    groups: [
      { id: 'asthma-guidelines', label: 'Asthma Guidelines', start: 1, end: 10 },
      { id: 'asthma-clinical-cases', label: 'Asthma Clinical Cases', start: 11, end: 20 },
      { id: 'pulmonary-function-tests', label: 'Pulmonary Function Tests', start: 21, end: 30 },
      { id: 'pulmonary-embolism', label: 'Pulmonary Embolism', start: 31, end: 40 },
      { id: 'valvular-disease', label: 'Valvular Disease', start: 41, end: 50 },
      { id: 'rheumatic-fever', label: 'Rheumatic Fever', start: 51, end: 60 },
      { id: 'chest-symptomatology', label: 'Chest Symptomatology', start: 61, end: 70 },
      { id: 'systemic-hypertension', label: 'Systemic Hypertension', start: 71, end: 80 }
    ]
  }
]
...
const sourceHashesComment = generatedSources.map((source) => `// ${source.label} SHA-256: ${source.sourceHash}`).join('\n')
