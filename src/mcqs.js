...
;(() => {
  ...
  toSource('NUT Quiz', {
    ...
    mcqs: [
      ...
      q('The estimated average requirements of food energy for females aged 75 years:', ['2355 Kcal/day', '1810 Kcal/day', '2100 Kcal/day', '1900 Kcal/day'], 1, 'The estimated average requirements of food energy for females aged 75 years is 1810 Kcal/day.'),

      q('A key storage form of iron is:', ['Myoglobin', 'Ferritin', 'Hemoglobin', 'Transferrin'], 1, 'Ferritin is the primary intracellular storage form of iron.'),

      q('How many extra calories a day should you eat when breastfeeding?', ['100', '200', '600', '1000'], 2, 'Lactation requires an estimated additional 600 Kcal/day according to the source key.'),

      q('High fiber diet:', ['Lowers cholesterol', 'Promotes peristalsis', 'Improves glycemic control', 'All of the above'], 3, 'High fiber diets lower cholesterol, promote peristalsis, and improve glycemic control.'),

      q('Current recommendations are that:', ['All babies should be exclusively breastfed until around 6 months', 'Solids should be introduced at 4 months of age', 'Cow’s milk is appropriate for all children from 6 months', 'Bottle feeding is more appropriate for babies than breast feeding'], 0, 'Modern guidelines recommend exclusive breastfeeding until around 6 months.'),

      q('The elderly are at an increased risk for deficiency of what two vitamins?', ['Vitamin D and B1', 'Vitamin D and B12', 'Vitamin A and B1', 'Vitamin A and B12'], 1, 'Vitamin D and B12 deficiencies are common in the elderly due to reduced synthesis and absorption.'),

      q('Marasmus is not characterized by:', ['swelling of limbs', 'replacing tissue proteins', 'impaired growth', 'protein deficiency'], 0, 'Swelling of limbs (edema) is characteristic of Kwashiorkor, not Marasmus.'),

      q('Extensive oedema, fat underneath skin, swelling of parts of body are all associated with:', ['Kwashiorkor', 'Marasmus', 'Both A&B', 'Protemia'], 0, 'Edema with subcutaneous fat is characteristic of Kwashiorkor.'),

      q('Direct tools of nutritional assessment include all of the following except:', ['Dietary survey', 'Clinical examination', 'Prevalence of iron deficiency anemia', 'Serum proteins and amino acids'], 2, 'Prevalence of iron deficiency anemia is an indirect indicator, not a direct assessment tool.'),

      q('The main cause of obesity is:', ['Nutritional', 'Endocrinal', 'Genetic', 'Familial tendency'], 0, 'The main cause of obesity is nutritional (imbalance between energy intake and expenditure).'),

      q('A man 200 cm in height and 96 kg in weight, is considered:', ['Non obese', 'Mild overweight', 'Moderate overweight', 'Severe overweight'], 1, 'The exam key considers this combination as mild overweight.'),

      q('If a person’s height is 170 cm and his weight is 80 kg and the table displaying the desired weight for height shows that the desired is 70 kg, the relative weight is:', ['100%', '114%', '14%', '150%'], 1, 'Relative weight = (80 / 70) * 100 = 114%.'),

      q('Vitamin toxicity can occur with excessive intake of:', ['Vitamin A', 'Thiamine', 'pyridoxine', 'all of the above'], 0, 'Excessive intake of fat-soluble Vitamin A can lead to hypervitaminosis (toxicity).'),

      q('Macronutrient under nutrition includes:', ['Rickets', 'Anemia', 'Protein energy malnutrition (PME)', 'None of the above'], 2, 'Protein-energy malnutrition (PEM) is a form of macronutrient undernutrition.'),

      q('Iron deficiency anemia is common in:', ['Men', 'Infants', 'Postmenopausal woman', 'All of the above'], 1, 'IDA is common in infants due to rapid growth and low iron content of milk.'),

      q('Major dietary sources of iodine:', ['Sea foods', 'Sea salt', 'Cabbage and turnips', 'All of the above'], 0, 'Sea foods are the primary rich dietary source of iodine.'),

      q('The estimated average requirements of food energy for males aged 75 years:', ['2355 Kcal/day', '1900Kcal/day', '2100 Kcal/day', '1810 Kcal/day'], 1, 'The estimated average food energy requirement for males aged 75 years is 1900 Kcal/day.'),

      q('Which of the following increases risk for cancer of the esophagus?', ['Processed meat', 'Fruit and vegetables', 'Alcohol', 'Salt'], 2, 'Alcohol consumption is a significant risk factor for esophageal cancer.'),

      q('Normal new born should star breast feeding:', ['Immediately', 'after 6 hours', 'after 12 hours', 'after 24 hours'], 0, 'Breastfeeding should be initiated immediately after birth.'),

      q('Iodine deficiency:', ['Occurs especially in areas close to the sea', 'Is unlikely to be seen in mountainous areas', 'Only results from the lack of iodine in drinking water', 'Can result in permanent mental retardation', 'All the above'], 3, 'Severe iodine deficiency during development can result in permanent mental retardation (cretinism).'),

      q('What is the definition of overweight?', ['BMI > 25 kg/m2', 'BMI 25-27.9 kg/m2', 'BMI <25 kg/m2', 'BMI >30 kg/m2'], 1, 'The local exam definition of overweight is a BMI of 25-27.9 kg/m2.'),

      q('Dietary factors have a strong influence on the development of carcinomas. Gastric carcinoma is linked with:', ['High fat intake', 'Beef consumption', 'Smoked fish', 'Presence of nitrosamines'], 3, 'Nitrosamines in foods are strongly linked to gastric carcinoma.'),

      q('The best indicator for monitoring the impact of Iodine Deficiency Disorders control programme is:', ['Prevalence of goiter among school children', 'Neonatal Hypothyroidism', 'Urinary iodine levels among pregnant women', 'Idoine level is soil'], 2, 'Urinary iodine level is the best indicator to monitor current iodine status in a population.'),

      q('Which of the following could lead to iodine deficiency?', ['Low intake of fruits and vegetables', 'Intake only of locally grown food in central Africa', 'Insufficient caloric intake', 'Inadequate sunlight exposure'], 1, 'Eating only local crops in low-iodine soil areas (like central Africa) causes deficiency.'),

      q('Which of these factors reduces the risk for cancer of the colorectum?', ['Vitamin C', 'Dietary fiber', 'Alcohol', 'Estrogen'], 1, 'Dietary fiber reduces colorectal cancer risk by promoting peristalsis and clearing carcinogens.'),

      q('Man\'s body is 80 kg, his desirable weight is 70 kg, and his height is 200 cm, so his relative weight is:', ['50%', '114%', '100%', '150%'], 1, 'Relative weight = (80 / 70) * 100 = 114%.'),

      q('The estimated average requirements of food energy for males aged 60:74 years:', ['2100 kcal/day', '2355 kcal/day', '1810 kcal/day', '1900 kcal/day'], 1, 'The estimated average food energy requirement for males aged 60-74 is 2355 kcal/day.'),

      q('Food frequency questionnaire:', ['Guided interview of food consumed in the previous 24 hours', 'Observation of food meal before and after eating', 'Written account of food consumed during 3-7 days', 'Written survey of food consumption during a specific period'], 3, 'Food frequency questionnaire is a written survey assessing how often foods are consumed.'),

      q('What are the main causes of the obesity epidemic?', ['Increased energy quantity/density and a more sedentary lifestyle', 'Decreased leisure time activity', 'None of the options given is correct', 'Changes in genetic profiles'], 0, 'Excess calories combined with lack of physical activity drive the epidemic.'),

      q('Too little iodine can lead to the conditions known as:', ['Hyperthyroidism', 'Deaf mutism', 'Cretinism', 'Hypothyroidism'], 3, 'Iodine deficiency directly leads to hypothyroidism (underactive thyroid).'),

      q('Which one of them causes toxicity?', ['Vitamin A', 'Vitamin B12', 'Vitamin C'], 0, 'Excess fat-soluble Vitamin A is stored and can cause toxicity.'),

      q('Pyridoxine deficiency results in:', ['Anemia', 'Convulsion in infants', 'Neuropathy', 'All of the above'], 3, 'Pyridoxine deficiency causes microcytic anemia, infant convulsions, and peripheral neuropathy.'),

      q('Most common vitamins whose deficiency causes anemia are:', ['Niacin', 'Vitamin A', 'Pyridoxine', 'Vitamin B1'], 2, 'Pyridoxine (B6) is required for heme synthesis and its deficiency causes microcytic anemia.'),

      q('Therapeutic dose of Vit C is:', ['100-1000 mg/hour', '10 gm/day', '100-1000 mg/day'], 2, 'The standard therapeutic dose of Vitamin C is 100-1000 mg/day.'),

      q('Breast feeding is not recommended in:', ['Diabetes', 'Tuberculosis had been treated', 'hepatitis', 'HIV'], 3, 'HIV can be transmitted via breast milk; hence it is a contraindication.'),

      q('Most risk factor of Breast cancer in postmenopausal women:', ['Red meat', 'Obesity', 'Fish', 'Dietary products'], 1, 'Obesity is the main dietary risk factor for postmenopausal breast cancer due to estrogen production in adipose tissue.'),

      q('Bow legs is an early sign of rickets.', ['True', 'False'], 1, 'False. Bow legs is a late sign of rickets, whereas cranial tabes and restlessness are early signs.'),

      q('Tea decreases the bioavailability of iron.', ['True', 'False'], 0, 'True. Tannins in tea chelate iron and inhibit its absorption.'),

      q('Main cause of breast cancer is obesity.', ['True', 'False'], 1, 'False. Obesity is a risk factor, not the primary cause of breast cancer.'),

      q('Fibers prevent colorectal cancer by rapid expulsion of carcinogens out of body.', ['True', 'False'], 0, 'True. Fiber increases stool bulk and transit speed, reducing carcinogen contact time.'),

      q('Risky diet for cancer includes cabbage and cauliflower.', ['True', 'False'], 1, 'False. Cruciferous vegetables contain protective anti-cancer compounds.'),

      q('History of dietary intake is the best method to assess the nutritional status of an elderly.', ['True', 'False'], 1, 'False. Anthropometric and laboratory tests are more objective and accurate.'),

      q('Iron requirements increase during menopause.', ['True', 'False'], 1, 'False. Requirements decrease during menopause because menstrual blood loss stops.'),

      q('Transplacental transfer of maternal thyroxine to the fetus may protect the infant from the effects of hypothyroidism.', ['True', 'False'], 0, 'True. Maternal thyroxine crosses the placenta and offers partial protection.'),

      q('The baby who have vit D deficiency sleep excessively.', ['True', 'False'], 1, 'False. Babies with vitamin D deficiency typically sleep poorly and are restless.'),

      q('Alkaline phosphatase level tends to be low in rickets.', ['True', 'False'], 1, 'False. Alkaline phosphatase is elevated in rickets due to active osteoblast compensation.'),

      q('Watching too much television can contribute to obesity.', ['True', 'False'], 0, 'True. Television viewing is associated with physical inactivity and snacking.'),

      q('Deficiency of riboflavin can result in angular stomatitis.', ['True', 'False'], 0, 'True. Riboflavin deficiency classically presents with cheilosis and angular stomatitis.'),

      q('Water soluble vitamins are mostly toxic.', ['True', 'False'], 1, 'False. Excess water-soluble vitamins are easily excreted in the urine and are rarely toxic.'),

      q('Pellagra and stomatitis are features of nicotinic acid deficiency.', ['True', 'False'], 0, 'True. Niacin (nicotinic acid) deficiency leads to pellagra.'),

      q('Quitters of tobacco smoking may gain weight.', ['True', 'False'], 0, 'True. Stopping smoking often reduces metabolic rate and increases appetite.'),

      q('Iron requirements are the same in men and women.', ['True', 'False'], 1, 'False. Premenopausal women have higher requirements due to menstrual blood loss.')
